...
<center>
    ...
    if(isset($_POST['nis'])) {
        ...
        <form action="surat_pindah_sekolah.php" method="post">
            ...
            <table cellspacing="10">
                ...
                <tr>
                    <td>Pindah Ke</td>
                    <td>:</td>
                    <td><input type="text" name="pindah_ke" required></td>
                </tr>
                <tr>
                    <td>Alasan Pindah</td>
                    <td>:</td>
                    <td><textarea name="alasan_pindah" id="" required></textarea></td>
                </tr>
            </table>
            </fieldset>
            <br>
        ...
        <?php
        // jika tidak ada data orang tua/wali
